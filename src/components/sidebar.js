        ...
        return (
            <div className="">
                <div className ="side">
                       ...
                       {
                         this.props.data.whichpage.toLowerCase() == 'arrival' ? (<div className="lastlist first">
                         <FontAwesomeIcon icon={faShoppingCart} />  <Link to='/arrival'><span style={{marginLeft:10}}>Arrival</span></Link>
                        </div>) :(<div className="lastlist others">
                         <FontAwesomeIcon icon={faShoppingCart} />  <Link to='/arrival'><span style={{marginLeft:10}}>Arrival</span></Link>
                        </div>)
                       }
